...
function CreateOrder() {
  ...
  const isLoadingAddr = addrStatus === 'loading';
      ...
      <Form method="POST" action="/order/new">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className=" mx-0.5 mt-1 rounded-md bg-red-100 p-2 text-xs text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
...
export const action = async ({ request }) => {
  ...
  if (!isValidPhone(order.phone))
    errors.phone =
      'Invalid phone number. Please provide your valid phone number to place the order.';
